 ...
 * paths to rendered strings. Ignores files whose names match the 'ignore'
 * expression in their directory metadata. The expression is treated as a
...
Statil.prototype.renderAll = function(data) {
  ...
  _.each(this.templates, function(t, path) {
    ...
    if (meta && typeof meta.ignore === 'string' || _.isRegExp(meta)) {
