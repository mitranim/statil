 ...
 */
Statil.prototype.register = function(source /* : string */, path /* : string */) /* : void */ {
 ...
 */
Statil.prototype.meta = function(path /* : string */) /* : ?any */ {
  // Validate the input.
  validateString(path)
 ...
 */
Statil.prototype.legend = function(path /* : string */) /* : ?Legend */ {
  // Validate the input.
  validateString(path)
 ...
 */
methods.renderTemplate = function(path /* : string */, data /* : ?{} */) /* : {} */ {
  var buffer = Object.create(null)

  // Enhance the locals with the legend.
  var legend = this.legend(path)
  data = _.assign(clone(data), legend)
  ...
  if (legend && legend.echo) {
    ...
    datas = legends.map(function(legend) {
      ...
      return _.assign(clone(data), legend)
    })
  }
 ...
 */
methods.renderThrough = function(path /* : string */, data /* : ?{} */) /* : string */ {
  // Validate the path.
  validateTruthyString(path)
...
methods.imports = function() /* : {} */ {
   ...
   */
  imports.$include = function $include(path /* : string */, data /* : {} */) /* : string */ {
    // Clone the data object and pass arguments to #renderOne.
    data = clone(data)
    return methods.renderOne.call(self, path, data)
  }
   ...
   * ignored.
   */
  imports.$entitle = function $entitle(title /* : string */, data /* : {} */) /* : void */ {
   ...
   * string otherwise.
   */
  imports.$active = function $active(path /* : string */, data /* : {} */) /* : string */ {
    if (!_.isObject(data)) return ''
 ...
 * into that object.
 */
methods.locals = function(path /* : string */, data /* : {} */) /* : void */ {
  // Validate the input.
  validateString(path)
 ...
 */
function resolveEchos(meta /* : {} */, echo /* : ?string|?Legend[] */) /* : [] */ {
  var echos /* : ?[] */
...
/**
 * Makes sure the value is a writable hash.
 */
function writable(value /* : any */) /* : {} */ {
  return _.isObject(value) ? value : Object.create(null)
}
