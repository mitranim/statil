 ...
 */
Statil.prototype.render = function(data /* : ?{} */) /* : Hash */ {
  var buffer = new Hash()
 ...
 */
methods.renderTemplate = function(path /* : string */, data /* : ?{} */) /* : Hash */ {
  var buffer = new Hash()
 ...
 * Pure hash table.
 */
function Hash(attrs /* : any */) {_.assign(this, attrs)}
